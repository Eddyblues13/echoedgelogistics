            ...
            <div class="live-tracking">
                ...
                <div class="tracking-path">
                    <div class="tracking-line">
                        <div class="tracking-progress" style="width: {{ $package->progress_percentage ?? 0 }}%;"></div>
                        <div class="tracking-point"></div>
                    </div>
                </div>

                <div class="tracking-locations">
                    @foreach($package->trackingLocations as $location)
                    <div class="location {{ $location->is_current ? 'active' : '' }}">
                ...
                @php
                $current = $package->trackingLocations->firstWhere('is_current', true);
                @endphp
                ...
                <div class="current-location">
                    ...
                    <span id="currentLocation">
                        Currently in {{ $current->location_name }} - {{ $current->status ?? 'In Transit to Next
                        Facility' }}
                    </span>
                </div>
                @endif
                        ...
                        <table class="detail-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Echo Edge LogisticsExpress</td>
                                </tr>
                                <tr>
    ...
    <script>
        ...
        document.getElementById('refreshBtn')?.addEventListener('click', function () {
            ...
            setTimeout(() => {
                ...
                // Set actual current location
                const currentLocation = @json($currentLocation);
                if (currentLocation) {
                    document.getElementById('currentLocation').textContent =
                        `${currentLocation.location_name} - ${currentLocation.status}`;
                }
        ...
        // Simulate live tracking (progress bar only)
